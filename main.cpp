...
auto __vectorcall main() -> std::int32_t
{
    try
    {
        ...
        /* judul pengaturan */
        SetConsoleTitleW(L"coolmathgames | faceit-server-crash");
        ...
        /* potong teks yang disediakan menjadi ip dan port */
        ...
        /* pengiriman paket loop */
        while (true)
        {
            /* melakukan resolusi dns dan membuat struktur alamat soket */
